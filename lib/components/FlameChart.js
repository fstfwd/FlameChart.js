...
var FlameChart = function (_React$Component) {
  ...
  (0, _createClass3.default)(FlameChart, [{
    ...
    value: function _handleDragStart() {
      var _calculator = this.calculator,
          offsetMinRatio = _calculator.offsetMinRatio,
          offsetMaxRatio = _calculator.offsetMaxRatio;
    ...
    value: function _handleWheel(e) {
      var _props = this.props,
          ...
          max = _props.max;
      var calculator = this.calculator,
          _calculator2 = this.calculator,
          offsetMinRatio = _calculator2.offsetMinRatio,
          offsetMaxRatio = _calculator2.offsetMaxRatio;
    ...
    value: function _getHeights(stackHeights, stackCollapsed) {
      ...
      var stackDividerHeights = children.length * 3;
