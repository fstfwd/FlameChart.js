...
var FlameChart = function (_React$Component) {
  ...
  (0, _createClass3.default)(FlameChart, [{
    ...
    value: function _handleDrag(start, end, delta) {
      ...
      var rate = Math.pow(1 - (offsetMinRatio + offsetMaxRatio), FlameChart.SCROLL_DECELERATION_RATIO);
    ...
    value: function render() {
      ...
      var firstPane = true;
      var splitPanes = [_react2.default.createElement('div', { key: '-1',
        className: 'banner' })];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { style: { position: 'absolute', top: overviewTimelineHeaderHeight, left: 0, fontSize: 0 } },
              overviewCanvases
            ),
            _react2.default.createElement(
              'div',
...
FlameChart.SCROLL_DECELERATION_RATIO = 1.1;
