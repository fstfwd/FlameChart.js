...
var Stack = function (_React$Component) {
  ...
  (0, _createClass3.default)(Stack, [{
    ...
    value: function _computeEntryRects() {
      ...
      var _calculator$getRange = calculator.getRange(),
          min = _calculator$getRange.min;

      var _calculator$getOffset = calculator.getOffsetRange(),
          offsetMin = _calculator$getOffset.min,
          offsetMax = _calculator$getOffset.max;

      var scrollLeft = calculator.getOffsetLeft();
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(entries), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          var entryWidth = (end - start) / offsetRange * width;
    ...
    value: function _renderOverview() {
      ...
      var _overviewCalculator$g = overviewCalculator.getRange(),
          min = _overviewCalculator$g.min,
          max = _overviewCalculator$g.max;
