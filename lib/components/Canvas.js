  ...
  (0, _createClass3.default)(Canvas, [{
    ...
    value: function frameStart() {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        _context.fillText('DPI: ' + currDPI.toFixed(2) + '; FRAME: ' + frameCount + '; FPS: ' + fps.toFixed(2), 5, _height - 5);
      }
    }
  }, {
    key: 'frameEnd',
...
Canvas.DPI = window.devicePixelRatio || 1;
Canvas.DPI_INC = 0.05;
Canvas.DPI_DSC = 0.1;
Canvas.PREFERRED_FRAME_TIME = 1000 / 60;
Canvas.MIN_DPI = window.devicePixelRatio * 0.5 + Canvas.DPI_INC;
Canvas.MAX_DPI = window.devicePixelRatio || 1;
