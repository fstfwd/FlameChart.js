...
SimpleStack.SEARCH_INPUT_DEBOUNCE = 500;
...
var SimpleFlameChart = exports.SimpleFlameChart = function (_React$Component2) {
  ...
  function SimpleFlameChart() {
    ...
    return _ret = (_temp = (_this2 = (0, _possibleConstructorReturn3.default)(this, (_ref = SimpleFlameChart.__proto__ || (0, _getPrototypeOf2.default)(SimpleFlameChart)).call.apply(_ref, [this].concat(args))), _this2), _this2.ref = {}, _this2.state = {
    ...
    }, _this2.searchTimeout = 0, _temp), (0, _possibleConstructorReturn3.default)(_this2, _ret);
  }
  ...
  (0, _createClass3.default)(SimpleFlameChart, [{
    ...
    key: '_timingContains',
    value: function _timingContains(_ref2, query) {
      var name = _ref2.name;

      return String(name).toLowerCase().indexOf(query) > -1 || _matcher2.default.isMatch(name, query);
    }
  }, {
    key: '_performSearch',
    value: function _performSearch(query) {
      var _props = this.props,
          timings = _props.timings,
          _props$timingContains = _props.timingContains,
          timingContains = _props$timingContains === undefined ? this._timingContains : _props$timingContains;
      ...
      this.setState({ query: query, highlighted: highlighted, highlightCount: highlightCount });
    }
  }, {
    ...
    value: function render() {
      ...
      var stacks = (0, _flow3.default)([(0, _map5.default)(function (_ref3) {
        var props = _ref3.props,
            _ref3$props = _ref3.props,
            _ref3$props$types = _ref3$props.types,
            types = _ref3$props$types === undefined ? [] : _ref3$props$types,
            name = _ref3$props.name;
      ...
      }), (0, _filter4.default)(function (_ref4) {
        var length = _ref4.timings.length,
            visible = _ref4.visible;
        return visible && length > 0 ? visibleStackCount += 1 : 0;
      }), (0, _map5.default)(function (_ref5) {
        var timings = _ref5.timings,
            _ref5$props = _ref5.props,
            name = _ref5$props.name,
            getTimingColor = _ref5$props.getTimingColor,
            isTimingSelected = _ref5$props.isTimingSelected,
            onTimingClick = _ref5$props.onTimingClick,
            props = (0, _objectWithoutProperties3.default)(_ref5$props, ['name', 'getTimingColor', 'isTimingSelected', 'onTimingClick']);
...
SimpleFlameChart.RESIZE_DEBOUNCE_TIMEOUT = 300;
SimpleFlameChart.defaultProps = {
  theme: 'dark',
  timings: [],
  groups: []
};
function renderSimpleFlameChart(_ref6, element) {
  var _ref6$timings = _ref6.timings,
      timings = _ref6$timings === undefined ? [] : _ref6$timings,
      _ref6$stacks = _ref6.stacks,
      stacks = _ref6$stacks === undefined ? [] : _ref6$stacks,
      opts = (0, _objectWithoutProperties3.default)(_ref6, ['timings', 'stacks']);
  ...
  (0, _createClass3.default)(WrappedFlameChart, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          containerHeight = _props3.containerHeight,
          props = (0, _objectWithoutProperties3.default)(_props3, ['containerWidth', 'containerHeight']);
