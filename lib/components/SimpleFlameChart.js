...
SimpleStack.SEARCH_INPUT_DEBOUNCE = 200;
...
var SimpleFlameChart = exports.SimpleFlameChart = function (_React$Component2) {
  ...
  function SimpleFlameChart() {
    ...
    }, _this3.searchTimeout = 0, _temp), (0, _possibleConstructorReturn3.default)(_this3, _ret);
  }
  ...
  (0, _createClass3.default)(SimpleFlameChart, [{
    ...
    value: function _performSearch() {
      var _props2 = this.props,
          ...
          _props2$timingContain = _props2.timingContains,
          timingContains = _props2$timingContain === undefined ? this._timingContains : _props2$timingContain;
      ...
      this.setState({ highlighted: highlighted, highlightCount: highlightCount });
    }
  }, {
    ...
    value: function _handleInput(e) {
      ...
      this.setState({ query: e.target.value }, function () {
        _this4.searchTimeout = setTimeout(function () {
          _this4._performSearch();
    ...
    value: function render() {
      ...
      var stacks = (0, _flow3.default)([(0, _map5.default)(function (_ref3) {
        ...
        groupVisibilityToggles.push(_react2.default.createElement(
          ...
          _react2.default.createElement(_rcCheckbox2.default, { checked: visible,
            ...
            onChange: function onChange() {
              return _this5._setGroupVisibility(name, !visible);
            } }),
        ...
        return _react2.default.createElement(_FlameChart.Stack, (0, _extends3.default)({ key: idx++,
          ...
          entryFillGetter: getTimingColor || _this5._getTimingColor.bind(_this5),
          entrySelectedGetter: isTimingSelected || _this5._isTimingSelected.bind(_this5),
          onEntryClick: onTimingClick || _this5._onTimingClick.bind(_this5) }));
